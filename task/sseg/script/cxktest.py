...
config = collections.OrderedDict(
    [
        ...
        # arguments - exp
        ('resume', 'result/deeplabv2_pascalvoc_1-8_sslgct_cxk/2020-09-14_13:39:39/ckpt/checkpoint_20.ckpt'),
        ('validation', True),
        ...
        ('sublabeled_path', 'dataset/PascalVOC/sublabeled_prefix/1-8/train_aug_labeled_1-8.txt'),
